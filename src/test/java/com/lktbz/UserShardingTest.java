...
import com.lktbz.entity.UserInfo;
import com.lktbz.service.UserService;
...
public class UserShardingTest {
	...
	public void testRange(){
		List<UserInfo> userInfos = userService.selectByRange(2l, 200l);
		userInfos.forEach((p)->System.out.println(p));
	}
}
